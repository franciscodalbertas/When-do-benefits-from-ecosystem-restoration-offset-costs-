...
The list of municipalities is located at the file "list_mun.csv" within the tables folder. future*)
...
- the net present value of the difference between the future scenarios and the baseline (*npv_yield_USD_
